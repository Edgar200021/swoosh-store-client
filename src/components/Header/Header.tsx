...
export const Header = ({ className }: Props) => {
  return (
    <header
      className={cn(
        'fixed !z-50 w-full h-[120px] backdrop-blur-xl ',
        className
      )}
    >
      ...
      <div className="border-[#EAEAEA] border-y-[1px] relative ">
        <div className="container flex items-center gap-x-4 justify-between  ">
          <div className="w-[88px] h-5 pr-[30px]  flex items-center justify-center py-6 border-r-[1px] border-r-[#EAEAEA] shrink-0">
