    ...
    >
      <div className="container flex gap-x-40 lg-tablet:gap-x-10  gap-y-10 flex-wrap justify-between mb-[50px]">
        <div className="max-w-[214px] lg-phone:gap-x-5  lg-phone:flex lg-phone:max-w-full lg-phone:flex-wrap lg-phone:justify-between  ">
          ...
          <span className="text-[13px] text-[#6B6B6B] block max-w-[180px] lg-phone:max-w-full lg-phone:text-center lg-phone:w-full">
            Instagram является запрещенной соц.сетью в РФ
          </span>
        </div>
        <div className="text-white flex justify-between  phone:flex-col phone:gap-x-0 phone:gap-y-[10px] phone:items-center gap-x-[60px]  tablet:grow-0 phone:grow">
      ...
      <div className="container flex items-center justify-between text-white gap-x-10 tablet:flex-col tablet:gap-x-0 tablet:gap-y-5 tablet:text-center">
        <span>
